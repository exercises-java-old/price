 ...
 */
@SpaceClass
public class PriceBalanceEntity extends IdEntity<String> {
    ...
    private PriceBalanceEntity() {
    }

    private PriceBalanceEntity(Builder builder) {
    ...
    public static class Builder extends AbstractEntityBuilder<PriceBalanceEntity> {
        ...
        public PriceBalanceEntity.Builder withId(String id) {
            this.id = id;
            return this;
        }

        public PriceBalanceEntity.Builder withArrangementId(String arrangementId) {
            this.arrangementId = arrangementId;
            return this;
        }

        public PriceBalanceEntity.Builder withBatchId(String batchId) {
            this.batchId = batchId;
            return this;
        }

        public PriceBalanceEntity.Builder withInsertionTimestamp(Instant insertionTimestamp) {
            this.insertionTimestamp = insertionTimestamp;
            return this;
        }

        public PriceBalanceEntity.Builder withBalances(Set<Balance> balances) {
            this.balances = balances;
            return this;
        }

        @Override
        public PriceBalanceEntity build() {
            return new PriceBalanceEntity(this);
        }
    }
}
