...
@RunWith(Suite.class)
@Suite.SuiteClasses({
        PriceComponentServiceIntegrationTest.class
})
@FixMethodOrder(MethodSorters.NAME_ASCENDING)
public class PriceComponentServiceIntegrationTestSuite {
    ...
    public static SpringContextRule getExportContext() {
        if (EXPORT_TEST_RULE == null) {
            EXPORT_TEST_RULE = new SpringContextRule()
                    .addXmlConfiguration("price-component-dao.xml")
                    .addXmlConfiguration("price-component-service.xml")
                    .addXmlConfiguration("price-component-test-export.xml")
                    .addXmlConfiguration("price-component-test-space.xml")
    ...
    public static synchronized SpringContextRule getImportContext() {
        if (IMPORT_TEST_RULE == null) {
            ...
            IMPORT_TEST_RULE.addXmlConfiguration("price-component-client.xml");
            IMPORT_TEST_RULE.addXmlConfiguration("price-component-test-import.xml");
