...
@DomainClass
public class CreatePriceTransactionRequest extends ValueObject {
    ...
    private CreatePriceTransactionRequest() {
    }

    private CreatePriceTransactionRequest(Builder builder) {
    ...
    public static class Builder implements com.so4it.common.builder.Builder<CreatePriceTransactionRequest>{
        ...
        @Override
        public CreatePriceTransactionRequest build() {
            return new CreatePriceTransactionRequest(this);
        }
    }
