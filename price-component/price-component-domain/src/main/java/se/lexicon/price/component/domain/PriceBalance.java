 ...
 *
 *
 * Represents a immutable balance statement on an price.
 *
 *
 * @author Magnus Poromaa {@literal <mailto:magnus.poromaa@so4it.com/>}
 */
@DomainClass
public class PriceBalance extends ValueObject {
    ...
    private PriceBalance() {
    }

    private PriceBalance(Builder builder) {
    ...
    public static class Builder implements com.so4it.common.builder.Builder<PriceBalance>{
        ...
        @Override
        public PriceBalance build() {
            return new PriceBalance(this);
        }
    }
