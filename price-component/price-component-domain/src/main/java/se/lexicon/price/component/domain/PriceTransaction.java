...
@DomainClass
public class PriceTransaction extends ValueObject {
    ...
    private PriceTransaction() {
    }

    private PriceTransaction(Builder builder) {
    ...
    public static class Builder implements com.so4it.common.builder.Builder<PriceTransaction>{
        ...
        @Override
        public PriceTransaction build() {
            return new PriceTransaction(this);
        }
    }
