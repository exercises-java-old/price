...
public class PriceApiIntegrationTestSuite {
    ...
    public static SpringContextRule getComponentRule() {
        if (COMPONENT_TEST_RULE == null) {
            ...
            COMPONENT_TEST_RULE.addXmlConfiguration("price-component-dao.xml");
            COMPONENT_TEST_RULE.addXmlConfiguration("price-component-service.xml");
            COMPONENT_TEST_RULE.addXmlConfiguration("price-component-test-space.xml");
            COMPONENT_TEST_RULE.addXmlConfiguration("price-component-test-export.xml");
    ...
    public static SpringContextRule getApiRule() {
        if (API_TEST_RULE == null) {
            ...
            API_TEST_RULE.addXmlConfiguration("price-component-client.xml");
            API_TEST_RULE.addXmlConfiguration("price-component-test-import.xml");
            API_TEST_RULE.addXmlConfiguration("price-api-server.xml");
            API_TEST_RULE.addXmlConfiguration("price-api-server-export.xml");
    ...
    public static ServiceBindingRule getServiceBindingRule() {
        if (SERVICE_BINDING_RULE == null) {
            ...
            SERVICE_BINDING_RULE.addServiceProvider(PriceComponentServiceProvider.class);
        }
